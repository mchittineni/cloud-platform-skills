...
!!! info "Skill metadata"
    **Name** `configuration-management-ansible` · **Level** `mid` · **Tags** `ansible` `configuration-management` `yaml` `automation` `devops-core`
    ...
    Source: [`skills/devops-core/configuration-management-ansible/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/configuration-management-ansible/SKILL.md)
