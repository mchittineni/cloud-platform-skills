...
!!! info "Skill metadata"
    **Name** `devops-metrics-dora-kpis` · **Level** `senior` · **Tags** `dora` `metrics` `kpis` `devops-core` `continuous-delivery` `analytics`
    ...
    Source: [`skills/devops-core/devops-metrics-dora-kpis/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/devops-metrics-dora-kpis/SKILL.md)
