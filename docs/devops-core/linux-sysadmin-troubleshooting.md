...
!!! info "Skill metadata"
    **Name** `linux-sysadmin-troubleshooting` · **Level** `junior` · **Tags** `linux` `sysadmin` `bash` `networking` `troubleshooting` `devops-core`
    ...
    Source: [`skills/devops-core/junior-foundation/linux-sysadmin-troubleshooting/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/junior-foundation/linux-sysadmin-troubleshooting/SKILL.md)
