...
!!! info "Skill metadata"
    **Name** `terraform-iac-modules` · **Level** `mid` · **Tags** `terraform` `iac` `hcl` `automation` `devops-core`
    ...
    Source: [`skills/devops-core/mid-level-automation/terraform-iac-modules/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/mid-level-automation/terraform-iac-modules/SKILL.md)
