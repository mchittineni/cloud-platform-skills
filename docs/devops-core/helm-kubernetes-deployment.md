...
!!! info "Skill metadata"
    **Name** `helm-kubernetes-deployment` · **Level** `mid` · **Tags** `helm` `kubernetes` `k8s` `packaging` `devops-core`
    ...
    Source: [`skills/devops-core/mid-level-automation/helm-kubernetes-deployment/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/mid-level-automation/helm-kubernetes-deployment/SKILL.md)
