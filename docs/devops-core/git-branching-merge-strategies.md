...
!!! info "Skill metadata"
    **Name** `git-branching-merge-strategies` · **Level** `junior` · **Tags** `git` `version-control` `trunk-based-development` `devops-core`
    ...
    Source: [`skills/devops-core/junior-foundation/git-branching-merge-strategies/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/junior-foundation/git-branching-merge-strategies/SKILL.md)
