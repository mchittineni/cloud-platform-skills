...
!!! info "Skill metadata"
    **Name** `cicd-pipeline-design` · **Level** `mid` · **Tags** `cicd` `github-actions` `gitlab-ci` `automation` `devops-core`
    ...
    Source: [`skills/devops-core/mid-level-automation/cicd-pipeline-design/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/mid-level-automation/cicd-pipeline-design/SKILL.md)
