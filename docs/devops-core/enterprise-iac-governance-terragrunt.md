...
!!! info "Skill metadata"
    **Name** `enterprise-iac-governance-terragrunt` · **Level** `staff` · **Tags** `terragrunt` `terraform` `opa` `governance` `devops-core`
    ...
    Source: [`skills/devops-core/senior-staff-architect/enterprise-iac-governance-terragrunt/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devops-core/senior-staff-architect/enterprise-iac-governance-terragrunt/SKILL.md)
