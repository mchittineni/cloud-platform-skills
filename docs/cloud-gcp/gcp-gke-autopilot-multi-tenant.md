...
!!! info "Skill metadata"
    **Name** `gcp-gke-autopilot-multi-tenant` · **Level** `senior` · **Tags** `gcp` `gke` `autopilot` `workload-identity` `vpc` `cloud`
    ...
    Source: [`skills/cloud-gcp/gcp-gke-autopilot-multi-tenant/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/cloud-gcp/gcp-gke-autopilot-multi-tenant/SKILL.md)
