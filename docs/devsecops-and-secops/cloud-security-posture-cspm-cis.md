...
!!! info "Skill metadata"
    **Name** `cloud-security-posture-cspm-cis` · **Level** `senior` · **Tags** `cspm` `prowler` `cis-benchmark` `cloud-security` `iam` `secops`
    ...
    Source: [`skills/devsecops-and-secops/cloud-security-posture-cspm-cis/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devsecops-and-secops/cloud-security-posture-cspm-cis/SKILL.md)
