...
!!! info "Skill metadata"
    **Name** `container-runtime-security-falco` · **Level** `senior` · **Tags** `falco` `runtime-security` `ebpf` `kubernetes` `secops` `devsecops`
    ...
    Source: [`skills/devsecops-and-secops/container-runtime-security-falco/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devsecops-and-secops/container-runtime-security-falco/SKILL.md)
