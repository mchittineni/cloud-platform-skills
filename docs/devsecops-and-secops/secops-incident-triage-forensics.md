...
!!! info "Skill metadata"
    **Name** `secops-incident-triage-forensics` · **Level** `staff` · **Tags** `secops` `incident-response` `forensics` `threat-hunting` `soc`
    ...
    Source: [`skills/devsecops-and-secops/secops-incident-triage-forensics/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/devsecops-and-secops/secops-incident-triage-forensics/SKILL.md)
