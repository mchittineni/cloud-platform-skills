...
!!! info "Skill metadata"
    **Name** `internal-developer-portal-backstage` · **Level** `staff` · **Tags** `platform-engineering` `backstage` `idp` `golden-paths` `devex`
    ...
    Source: [`skills/07-platform-engineering/internal-developer-portal-backstage/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/07-platform-engineering/internal-developer-portal-backstage/SKILL.md)
