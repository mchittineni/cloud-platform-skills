...
!!! info "Skill metadata"
    **Name** `cloud-native-microservices-patterns` · **Level** `senior` · **Tags** `cloud-native` `microservices` `12-factor` `kubernetes` `architecture` `platform-engineering`
    ...
    Source: [`skills/07-platform-engineering/cloud-native-microservices-patterns/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/07-platform-engineering/cloud-native-microservices-patterns/SKILL.md)
