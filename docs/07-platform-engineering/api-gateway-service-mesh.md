...
!!! info "Skill metadata"
    **Name** `api-gateway-service-mesh` · **Level** `senior` · **Tags** `api-gateway` `service-mesh` `istio` `envoy` `kong` `platform-engineering`
    ...
    Source: [`skills/07-platform-engineering/api-gateway-service-mesh/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/07-platform-engineering/api-gateway-service-mesh/SKILL.md)
