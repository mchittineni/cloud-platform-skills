...
!!! info "Skill metadata"
    **Name** `prometheus-grafana-otel-tracing` · **Level** `senior` · **Tags** `observability` `opentelemetry` `prometheus` `grafana` `tracing` `otel`
    ...
    Source: [`skills/sre-slo-sla-observability/prometheus-grafana-otel-tracing/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/sre-slo-sla-observability/prometheus-grafana-otel-tracing/SKILL.md)
