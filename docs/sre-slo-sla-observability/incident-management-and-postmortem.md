...
!!! info "Skill metadata"
    **Name** `incident-management-and-postmortem` · **Level** `staff` · **Tags** `sre` `incident-response` `postmortem` `ics` `runbooks`
    ...
    Source: [`skills/sre-slo-sla-observability/incident-management-and-postmortem/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/sre-slo-sla-observability/incident-management-and-postmortem/SKILL.md)
