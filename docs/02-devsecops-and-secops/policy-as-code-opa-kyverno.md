...
!!! info "Skill metadata"
    **Name** `policy-as-code-opa-kyverno` · **Level** `senior` · **Tags** `policy-as-code` `kyverno` `opa` `gatekeeper` `conftest` `governance` `kubernetes`
    ...
    Source: [`skills/02-devsecops-and-secops/policy-as-code-opa-kyverno/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/02-devsecops-and-secops/policy-as-code-opa-kyverno/SKILL.md)
