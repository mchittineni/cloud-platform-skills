...
!!! info "Skill metadata"
    **Name** `secrets-management-vault-kms` · **Level** `senior` · **Tags** `vault` `secrets` `kms` `kubernetes` `eso` `devsecops`
    ...
    Source: [`skills/02-devsecops-and-secops/secrets-management-vault-kms/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/02-devsecops-and-secops/secrets-management-vault-kms/SKILL.md)
