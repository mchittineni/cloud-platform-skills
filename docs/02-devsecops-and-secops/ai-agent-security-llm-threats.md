...
!!! info "Skill metadata"
    **Name** `ai-agent-security-llm-threats` · **Level** `senior` · **Tags** `ai-security` `llm` `prompt-injection` `agent-security` `owasp` `mitre-atlas` `devsecops`
    ...
    Source: [`skills/02-devsecops-and-secops/ai-agent-security-llm-threats/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/02-devsecops-and-secops/ai-agent-security-llm-threats/SKILL.md)
