...
!!! info "Skill metadata"
    **Name** `shift-left-security-sast-sca` · **Level** `mid` · **Tags** `devsecops` `sast` `sca` `sbom` `semgrep` `trivy` `security`
    ...
    Source: [`skills/02-devsecops-and-secops/shift-left-security-sast-sca/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/02-devsecops-and-secops/shift-left-security-sast-sca/SKILL.md)
...
- An SBOM or provenance artifact is required for compliance or a customer
