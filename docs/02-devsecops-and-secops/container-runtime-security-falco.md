...
!!! info "Skill metadata"
    **Name** `container-runtime-security-falco` · **Level** `senior` · **Tags** `falco` `runtime-security` `ebpf` `kubernetes` `secops` `devsecops`
    ...
    Source: [`skills/02-devsecops-and-secops/container-runtime-security-falco/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/02-devsecops-and-secops/container-runtime-security-falco/SKILL.md)
