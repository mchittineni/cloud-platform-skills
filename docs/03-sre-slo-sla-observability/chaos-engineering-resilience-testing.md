...
!!! info "Skill metadata"
    **Name** `chaos-engineering-resilience-testing` · **Level** `senior` · **Tags** `chaos-engineering` `resilience` `fault-injection` `gameday` `sre` `reliability` `aws-fis`
    ...
    Source: [`skills/03-sre-slo-sla-observability/chaos-engineering-resilience-testing/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/03-sre-slo-sla-observability/chaos-engineering-resilience-testing/SKILL.md)
