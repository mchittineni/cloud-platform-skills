...
!!! info "Skill metadata"
    **Name** `infrastructure-host-monitoring` · **Level** `mid` · **Tags** `monitoring` `node-exporter` `cadvisor` `infrastructure` `prometheus` `sre`
    ...
    Source: [`skills/03-sre-slo-sla-observability/infrastructure-host-monitoring/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/03-sre-slo-sla-observability/infrastructure-host-monitoring/SKILL.md)
