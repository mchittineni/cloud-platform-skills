...
!!! info "Skill metadata"
    **Name** `azure-aks-enterprise-landing-zones` · **Level** `senior` · **Tags** `azure` `aks` `cni` `workload-identity` `policy` `cloud`
    ...
    Source: [`skills/05-cloud-azure/azure-aks-enterprise-landing-zones/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/05-cloud-azure/azure-aks-enterprise-landing-zones/SKILL.md)
