...
!!! info "Skill metadata"
    **Name** `azure-cloud-engineering-patterns` · **Level** `senior` · **Tags** `azure` `cloud-engineering` `virtual-wan` `private-endpoints` `devops`
    ...
    Source: [`skills/05-cloud-azure/azure-cloud-engineering-patterns/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/05-cloud-azure/azure-cloud-engineering-patterns/SKILL.md)
