...
!!! info "Skill metadata"
    **Name** `write-a-skill` · **Level** `staff` · **Tags** `meta-skill` `skill-authoring` `progressive-disclosure` `standards` `productivity`
    ...
    Source: [`skills/productivity/write-a-skill/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/productivity/write-a-skill/SKILL.md)
