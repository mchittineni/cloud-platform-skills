...
!!! info "Skill metadata"
    **Name** `aws-cloud-migration-strategies` · **Level** `senior` · **Tags** `aws` `migration` `6rs` `dms` `mgn` `cloud-migration`
    ...
    Source: [`skills/cloud-aws/aws-cloud-migration-strategies/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/cloud-aws/aws-cloud-migration-strategies/SKILL.md)
