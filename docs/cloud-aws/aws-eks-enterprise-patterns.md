...
!!! info "Skill metadata"
    **Name** `aws-eks-enterprise-patterns` · **Level** `senior` · **Tags** `aws` `eks` `karpenter` `irsa` `kubernetes` `cloud`
    ...
    Source: [`skills/cloud-aws/aws-eks-enterprise-patterns/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/cloud-aws/aws-eks-enterprise-patterns/SKILL.md)
