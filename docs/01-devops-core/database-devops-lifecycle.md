...
!!! info "Skill metadata"
    **Name** `database-devops-lifecycle` · **Level** `senior` · **Tags** `database` `migrations` `flyway` `liquibase` `postgresql` `devops-core`
    ...
    Source: [`skills/01-devops-core/database-devops-lifecycle/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/01-devops-core/database-devops-lifecycle/SKILL.md)
