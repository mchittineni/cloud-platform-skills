...
!!! info "Skill metadata"
    **Name** `scripting-and-automation` · **Level** `mid` · **Tags** `bash` `python` `automation` `scripting` `cli` `devops-core`
    ...
    Source: [`skills/01-devops-core/scripting-and-automation/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/01-devops-core/scripting-and-automation/SKILL.md)
