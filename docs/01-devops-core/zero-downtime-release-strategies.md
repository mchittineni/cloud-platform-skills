...
!!! info "Skill metadata"
    **Name** `zero-downtime-release-strategies` · **Level** `senior` · **Tags** `canary` `blue-green` `argo-rollouts` `service-mesh` `istio` `devops-core`
    ...
    Source: [`skills/01-devops-core/senior-staff-architect/zero-downtime-release-strategies/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/01-devops-core/senior-staff-architect/zero-downtime-release-strategies/SKILL.md)
