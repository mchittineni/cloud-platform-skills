...
!!! info "Skill metadata"
    **Name** `docker-containerization-basics` · **Level** `junior` · **Tags** `docker` `containers` `multi-stage` `security` `devops-core`
    ...
    Source: [`skills/01-devops-core/junior-foundation/docker-containerization-basics/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/01-devops-core/junior-foundation/docker-containerization-basics/SKILL.md)
