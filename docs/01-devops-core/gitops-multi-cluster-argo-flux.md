...
!!! info "Skill metadata"
    **Name** `gitops-multi-cluster-argo-flux` · **Level** `senior` · **Tags** `gitops` `argocd` `flux` `multi-cluster` `kubernetes` `devops-core`
    ...
    Source: [`skills/01-devops-core/senior-staff-architect/gitops-multi-cluster-argo-flux/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/01-devops-core/senior-staff-architect/gitops-multi-cluster-argo-flux/SKILL.md)
