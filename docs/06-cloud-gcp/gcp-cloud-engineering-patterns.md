...
!!! info "Skill metadata"
    **Name** `gcp-cloud-engineering-patterns` · **Level** `senior` · **Tags** `gcp` `google-cloud` `shared-vpc` `iam` `cloud-engineering`
    ...
    Source: [`skills/06-cloud-gcp/gcp-cloud-engineering-patterns/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/06-cloud-gcp/gcp-cloud-engineering-patterns/SKILL.md)
