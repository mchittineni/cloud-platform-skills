...
!!! info "Skill metadata"
    **Name** `scalability-high-availability-patterns` · **Level** `senior` · **Tags** `scalability` `high-availability` `ha` `multi-az` `resilience` `cloud`
    ...
    Source: [`skills/04-cloud-aws/scalability-high-availability-patterns/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/04-cloud-aws/scalability-high-availability-patterns/SKILL.md)
