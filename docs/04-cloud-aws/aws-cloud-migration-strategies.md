...
!!! info "Skill metadata"
    **Name** `aws-cloud-migration-strategies` · **Level** `senior` · **Tags** `aws` `migration` `6rs` `dms` `mgn` `cloud-migration`
    ...
    Source: [`skills/04-cloud-aws/aws-cloud-migration-strategies/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/04-cloud-aws/aws-cloud-migration-strategies/SKILL.md)
...
- Post-migration cost governance -> `finops-framework-inform-optimize-operate`
- Target-state Kubernetes design -> `aws-eks-enterprise-patterns`
- Schema change mechanics -> `database-devops-lifecycle`
