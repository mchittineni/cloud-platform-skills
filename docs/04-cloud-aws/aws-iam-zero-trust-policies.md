...
!!! info "Skill metadata"
    **Name** `aws-iam-zero-trust-policies` · **Level** `senior` · **Tags** `aws` `iam` `scp` `zero-trust` `security` `cloud`
    ...
    Source: [`skills/04-cloud-aws/aws-iam-zero-trust-policies/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/04-cloud-aws/aws-iam-zero-trust-policies/SKILL.md)
