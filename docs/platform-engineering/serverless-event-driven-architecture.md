...
!!! info "Skill metadata"
    **Name** `serverless-event-driven-architecture` · **Level** `senior` · **Tags** `serverless` `lambda` `eventbridge` `sqs` `step-functions` `platform-engineering`
    ...
    Source: [`skills/platform-engineering/serverless-event-driven-architecture/SKILL.md`](https://github.com/mchittineni/cloud-platform-skills/blob/main/skills/platform-engineering/serverless-event-driven-architecture/SKILL.md)
