---
name: internal-developer-portal-backstage
description: "Internal Developer Platform engineering: Backstage software catalog and entity model, Golden Path scaffolder templates, TechDocs, and platform-as-product adoption and DevEx metrics. Use when building self-service so developers can create a new production-ready service in one click, defining golden paths, onboarding services into a catalog, or measuring platform adoption."
level: staff
tags: [platform-engineering, backstage, idp, golden-paths, devex]
