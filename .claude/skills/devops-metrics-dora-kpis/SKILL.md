---
name: devops-metrics-dora-kpis
description: "DORA metrics instrumentation: deployment frequency, lead time for changes, change failure rate, and time to restore, with PromQL dashboards, benchmark bands, and anti-gaming guidance. Use when measuring delivery performance, building an engineering-metrics dashboard, or diagnosing why throughput or stability is poor."
level: senior
tags: [dora, metrics, kpis, devops-core, continuous-delivery, analytics]
