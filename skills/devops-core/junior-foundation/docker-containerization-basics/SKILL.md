---
name: docker-containerization-basics
description: "Container image engineering: multi-stage builds, layer-cache ordering, non-root users, distroless and minimal base images, and image-size/attack-surface reduction. Use when writing or reviewing a Dockerfile, shrinking image size, fixing slow builds, or hardening containers before they reach a registry."
level: junior
tags: [docker, containers, multi-stage, security, devops-core]
