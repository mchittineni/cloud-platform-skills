---
name: gcp-gke-autopilot-multi-tenant
description: "GKE Autopilot and Standard multi-tenancy: namespace and node isolation, Workload Identity, network policy, Shared VPC topology, VPC Service Controls, and Autopilot vs Standard trade-offs. Use when designing a multi-tenant GKE platform, isolating tenant workloads, or choosing between Autopilot and Standard."
level: senior
tags: [gcp, gke, autopilot, workload-identity, vpc, cloud]
